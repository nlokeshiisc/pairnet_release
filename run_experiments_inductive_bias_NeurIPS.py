...
def init_arg() -> Any:
    ...
    parser.add_argument("--setup", default="twins", type=str)
    parser.add_argument("--file_name", default="sample", type=str)
    parser.add_argument("--n_exp", default=5, type=int)
...
if __name__ == "__main__":
    ...
    if (args.setup == "A") or (args.setup == "B"):
        ...
        # Appendix E.2
        do_twins_experiment_loop(file_name=args.file_name, n_exp=args.n_exp, save_reps=True)
    else:
        raise ValueError(
